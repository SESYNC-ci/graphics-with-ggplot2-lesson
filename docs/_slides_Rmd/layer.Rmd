...
```{r plot_box, title = '{{ site.handouts }}'}
ggplot(animals,
       aes(x = species_id, y = weight)) +
  geom_boxplot()
```
...
```{r plot_pt_box_plain, title = '{{ site.handouts }}'}
ggplot(animals,
       aes(x = species_id, y = weight)) +
  geom_boxplot() +
  geom_point()
...
```{r plot_pt_box, title = '{{ site.handouts }}'}
ggplot(animals,
       aes(x = species_id, y = weight)) +
  geom_boxplot() +
  geom_point(
...
```{r plot_box_color, title = '{{ site.handouts }}'}
ggplot(animals,
       aes(x = species_id, y = weight,
           color = species_id)) +
  geom_boxplot() +
