...
```{r message = FALSE, title='lesson-5.R'}
library(dplyr)
library(ggplot2)
...
```{r plot_lm_group, title='lesson-5.R'}
ggplot(data = surveys_dm,
       aes(x = year, y = weight)) + 
  geom_point(aes(shape = sex),
             size = 3,
...
```{r plot_lm_color, title='lesson-5.R'}
ggplot(data = surveys_dm,
       aes(x = year,
           y = weight,
           color = sex)) + 
...
```{r plot_lm_scales, title='lesson-5.R'}
...
```{r plot_lm_scales_2, title='lesson-5.R'}
year_wgt <- year_wgt +
...
```{r plot_hist_axes, warning = FALSE, title='lesson-5.R'}
histo <- histo + 
...
```{r plot_hist_themes, warning = FALSE, title='lesson-5.R'}
histo <- histo +
  theme_bw() +
...
```{r plot_facets, message = FALSE, title='lesson-5.R'}
...
```{r plot_facets_2, message = FALSE, title='lesson-5.R'}
ggplot(data = surveys_dm,
       aes(x = weight)) +
...
```{r plot_facets_3, message = FALSE, title='lesson-5.R'}
ggplot(data = surveys_dm,
...
```{r sol2, message = FALSE, title='lesson-5.R'}
filter(surveys, species_id == "DM") %>%
...
```{r sol3, message = FALSE, title='lesson-5.R'}
